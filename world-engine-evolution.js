...
- 持续中的天下大势可主动衍生符合其约束的新事件链：当某条大势在本轮迫使具体势力或区域采取可落地的对抗/推进行动时，应在 events 中新增对应事件链（起始 stage 为 conflict 的"萌芽"或 progress 的"筹备"），并在 desc 与 influenceChain 中写明"哪条大势 → 谁 → 因何被迫行动"。限制：每轮最多由大势衍生 1 条新事件链；衍生的事件链此后照常走骰子推进，与普通事件链无异。不得为凑数而衍生，没有具体落地行动时不得新增。
...
2. 将所有持续中的天下大势作为本轮世界级约束，并检查是否形成新大势或已有大势明确结束；同时检查持续中的大势是否在本轮迫使具体势力/区域采取可落地行动，若是则按 worldTrends 判定规则衍生新事件链（每轮至多 1 条）。
